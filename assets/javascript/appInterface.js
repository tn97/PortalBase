...
*/
  ...
  $(document).on("click", "#btnStock", function () {
    ...
    var stock = ("<div id='particles-js'><div class='container containerStock'><div class='stockFont'><div class='jumbotron gradient'>" +
      ...
      "<button type='submit' class='btn btn-default' id='run-search'><i class='fa fa-search'></i>Search</button><button class='btn btn-default' id='clear-all'><i class='fa fa-trash'></i> Clear" +
      ...
      "</div><div class='vol'></div></div></div></div></div><div class='row'><div class='col-sm-12'><hr></div></div></div></div></div></div></div>")
